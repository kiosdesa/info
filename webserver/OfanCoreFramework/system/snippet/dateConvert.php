<?php
function mimeToStringTime($time)
{
	return date("D, F, Y", $time);
}

function stringToMimeTime($time)
{
	return strtotime($time);
}

function dateToStringTime($time)
{
...
function dateTranslate($date, $lang)
{
...
function dateLangFormat($format, $syntax)
{
